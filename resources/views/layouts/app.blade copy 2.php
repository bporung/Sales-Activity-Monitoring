...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Codamize') }}</title>
        ...
        <div class="panelWrapper" x-data="{openNavigation : true}" >
            ...
            <div class="panelNavigation"  x-cloak  x-bind:class="openNavigation ? 'navigationTrue' : 'navigationFalse'">
                <div class="flex flex-col h-screen">
                    <div class="my-5 "><h5 class="font-semibold text-xl text-center">Owlbytes</h5></div>
                    <div class="mb-5 ">
                        <div class="">
                            <ul>
                                <li class="py-3"><span class="px-2 text-gray-500">Good Afternoon, Bryan</span></li>
                    ...
                    <div class="navigationScroll flex-grow overflow-hidden hover:overflow-y-auto">
                        <div class="">
                            <ul>
                                ...
                                <!--
                                     <li class="py-2"><a href="/announcement" class="px-5">Announcement  @livewire('component.websocket.announcementbadge')</a></li> 
                                -->
                        ...
                        <div class="">
                            <ul>
                                ...
                                @endcanany
                                @canany(['read all quotation','read self quotation'])
                                <li class="py-2"><a href="/quotation" class="px-5">Quotation</a></li>
                                @endcanany
                                @canany(['read all salesorder','read self salesorder'])
                                <li class="py-2"><a href="/salesorder" class="px-5">Sales Order</a></li>
                                @endcanany
                            </ul>
                        </div>
                        <div class="">
                            <ul>
                                <li class="py-3"><span class="px-2 text-gray-500">Data Processing</span></li>
                                @canany(['read all salesorderupdate','read self salesorderupdate'])
                                <li class="py-2"><a href="/dataprocessing/salesorder?q=all" class="px-5">Sales Order : Item</a></li>
                                @endcanany
                                @canany(['read all interactiongroup','read self interactiongroup'])
                                <li class="py-2"><a href="/dataprocessing/interactiongroup?q=all" class="px-5">Interaction Group</a></li>
                                @endcanany
                            </ul>
                        </div>
                        <div class="">
