    ...
    <x-modal wire:model="show">
        <div class="p-1 rounded">
            ...
            <div class="flex">
                ...
                <div>
                <p class="font-bold">Finalize Data</p>
                <p class="text-sm">The change you'll make can't be reverted.</p>
                </div>
            </div>
            </div>
        </div>
        <div class="p-2 mt-2 bg-white shadow w-full flex flex-wrap">
            <div class="formFieldWrapper">
                <label class="formFieldName" for="note">Note :</label>
            ...
            <div class="w-full mt-2 justify-end flex flex-wrap bg-white p-3 mb-5 order-last">
                <button class="bg-white px-3 py-2 border border-gray-700 text-gray-700 hover:bg-black hover:text-white transition-all" type="button" wire:click="finalizeData"><i class="fas fa-exclamation-triangle"></i> Finalize</button>
            </div>
        </div>
    </x-modal>
</div>