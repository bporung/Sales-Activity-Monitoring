                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @livewire('component.form.selector.singleselector',[
                                            ...
                                            'selectedItem' => isset($state['details'][$keyDetail]['item']) ? $state['details'][$keyDetail]['item'] : [],
                                            'selectedItemId' => isset($state['details'][$keyDetail]['item_id']) ? $state['details'][$keyDetail]['item_id'] : '',
                                ...
                                <div class="w-full mb-3 flex flex-wrap p-3 rounded bg-gray-200 border-gray-200 border">
                                    <div class="w-full flex items-center">
                                        ...
                                        @livewire('component.form.selector.singleselector',[
                                            ...
                                            'modelName' => 'App\Models\Item',
                                            'searchColumns' => ['name','code'],
                                            'selectedItem' => isset($state['details'][$key]['item']) ? $state['details'][$key]['item'] : [],
                                            'selectedItemId' => isset($state['details'][$key]['item_id']) ? $state['details'][$key]['item_id'] : '',
                                            'exclusionItemId' => isset($groupFlatten['ItemSingleSelector']) ? $groupFlatten['ItemSingleSelector'] : [],
                    ...
                    @else
                        @if($old_images)
                            ...
                            <div class="p-2 w-full flex flex-wrap">
                                ...
                                <div class="w-1/2 sm:w-1/2 md:w-1/2 lg:w-1/3 p-1 h-24 md:h-40 lg:h-40 shadow">
                                    <img class="h-full w-full" src="{{ $old_image->image }}" style="object-fit: cover;">
                                </div>
                                @endforeach
                            </div>
                        @endif
