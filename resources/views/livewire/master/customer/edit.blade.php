            ...
            <div class="">
                ...
                <div class="w-full mb-3">
                    ...
                    @livewire('component.form.selector.multiselector',[
                        ...
                        'selectedItemId' => $state['categories'],
                ...
                <div class="formFieldWrapper">
                    <label class="formFieldName" for="contact_name">PIC :</label>
                    <div class="w-full grid grid-cols-4 gap-x-2">
                        <input class="col-span-3 formField" id="pic" type="text" wire:model.defer.lazy="state.pic">
                    </div>
